...
class Proposal:
    def __init__(self, proposal_id, status, directorate, division, 
                    ...
                    program_officer, nsf_received_date, od_concur_date):
...
with open(file_path) as f:
    ...
    for line in lines:
        ...
        od_concur_date = nsf_received_date_obj + timedelta(days=30)
        ...
        proposal = Proposal(proposal_id, status, directorate, division, institution, institution_state, pi_name, pi_institution, 
                                ...
                                requested_amount, program_officer, nsf_received_date_obj.isoformat() + 'Z', od_concur_date.isoformat() + 'Z')
